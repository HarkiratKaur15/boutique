  ...
  return (
    <>
      <div className="bg-stone-100 ">
        <div className="  bg-[#365150] text-white text-center pt-4">
          {" "}
        ...
        <div className="">
          <div className="  lg:grid lg:grid-cols-3 gap justify-items-center px-72 -mt-28">
            {Catalog?.map((item) => (
              <div className="text-[#40251B] pb-10 ">
                ...
                {/* <button
                  ...
                  className="font-light text-sm pb-1 border-[#40251B]  border-b"
                >
                  View project
                </button> */}
                <div className="font-light pt-4 text-sm pb-1 border-[#40251B]  w-1/5  border-b" ><Link to={`/ViewProject/${item.id}`}>View project</Link></div>
              </div>
            ))}
          </div>
        </div>
